...
pub use wire::{
    encode_ack, encode_ack_batch, encode_bot_typing, encode_dest_cmd, encode_empty_cmd,
    encode_history, encode_inbox_list, encode_inbox_read, encode_login, encode_offline_content,
