...
pub use wire::{
    ...
    CMD_OFFLINE_CONTENT, CMD_OFFLINE_INDEX, CMD_PRESENCE, CMD_ROOM_ENTER, CMD_ROOM_LEAVE,
    CMD_USER_PROFILE, CMD_USER_SEARCH, CMD_USER_UPDATE, CMD_USER_UPDATED, INBOX_KIND_GROUP,
    INBOX_KIND_USER, MESSAGE_TYPE_IMAGE, MESSAGE_TYPE_TEXT, MESSAGE_TYPE_VIDEO, MESSAGE_TYPE_VOICE,
    META_ACCOUNT, META_APP, META_DEST_CHANNELS, META_DEST_SERVER, SN_CHAT, SN_LOGIN, SN_ROYAL,
