...
pub use wire::{
    ...
    CMD_OFFLINE_INDEX, MESSAGE_TYPE_IMAGE, MESSAGE_TYPE_TEXT, MESSAGE_TYPE_VIDEO,
    MESSAGE_TYPE_VOICE, META_DEST_CHANNELS, META_DEST_SERVER, SN_CHAT, SN_LOGIN, SN_WGATEWAY,
};
