...
pub const CMD_INBOX_STATES: &str = "chat.inbox.states";
pub const CMD_INBOX_READ_SYNC: &str = "chat.inbox.read.sync";
...
pub const TYPING_PHASE_COMPOSING: i32 = 0;
pub const TYPING_PHASE_QUEUED: i32 = 1;
pub const TYPING_PHASE_RUNNING: i32 = 2;
pub const TYPING_PHASE_TOOL: i32 = 3;
pub const TYPING_PHASE_WAIT_PERMISSION: i32 = 4;
