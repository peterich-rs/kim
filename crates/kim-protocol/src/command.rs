...
use crate::wire::{
    ...
    CMD_GROUP_QUIT, CMD_HISTORY, CMD_INBOX_LIST, CMD_INBOX_READ, CMD_LOGIN_RENEW,
    CMD_LOGIN_SIGN_IN, CMD_LOGIN_SIGN_OUT, CMD_OFFLINE_CONTENT, CMD_OFFLINE_INDEX, CMD_PRESENCE,
