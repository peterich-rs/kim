...
use crate::wire::{
    CMD_AGENT_SPEC_SYNC, CMD_AGENT_SPEC_UPSERT, CMD_BLOCK_ADD, CMD_BLOCK_LIST, CMD_BLOCK_REMOVE,
    CMD_BOT_CREATE, CMD_BOT_DELETE, CMD_BOT_PENDING, CMD_BOT_REPLY, CMD_BOT_TYPING, CMD_BOT_UPDATE,
    ...
    CMD_GROUP_CREATE, CMD_GROUP_DETAIL, CMD_GROUP_INVITE, CMD_GROUP_JOIN, CMD_GROUP_MEMBERS,
    CMD_GROUP_QUIT, CMD_HISTORY, CMD_INBOX_LIST, CMD_INBOX_READ, CMD_INBOX_READ_SYNC,
    CMD_INBOX_STATES, CMD_LOGIN_RENEW, CMD_LOGIN_SIGN_IN, CMD_LOGIN_SIGN_OUT, CMD_OFFLINE_CONTENT,
    CMD_OFFLINE_INDEX, CMD_PRESENCE, CMD_RECEIPT_READ, CMD_ROOM_ENTER, CMD_ROOM_LEAVE, CMD_TYPING,
    CMD_USER_PROFILE, CMD_USER_SEARCH, CMD_USER_UPDATE, CMD_USER_UPDATED,
};
...
define_commands! {
    ...
    InboxStates => CMD_INBOX_STATES,
    InboxReadSync => CMD_INBOX_READ_SYNC,
    History => CMD_HISTORY,
    ...
    BotTyping => CMD_BOT_TYPING,
    AgentSpecSync => CMD_AGENT_SPEC_SYNC,
    AgentSpecUpsert => CMD_AGENT_SPEC_UPSERT,
}
