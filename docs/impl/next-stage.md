...
| 字段 | 值 |
|---|---|
| 状态 | 切片 3–5 **代码已落地**。G-03 / G-04 / G-10 要等 rollout 才从 [production-gaps.md](../production-gaps.md) 删除 |
| 日期 | 2026-09-01 |
| 父规格 | 本文件只留未做合同。已落地形状在专题文档 |

切片 3–5 的逐步补丁已执行并写回专题文档，实施稿不保留。
...
| 5 | SIGTERM 先摘发现再 drain；而后 G-29 / G-30 | G-07 / G-32 |
| — | 心跳 Redis 有界宽限 | G-31 |
