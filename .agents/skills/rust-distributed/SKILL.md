...
description: >
  Distributed systems in Rust: Raft, two-phase commit, consensus, distributed
  transactions, consistency models, Snowflake IDs, and distributed locks.
  Use when designing gateway/chat clustering, service coordination, or
  consistency across nodes. Invoke with /rust-distributed.
license: MIT
metadata:
  author: huiali
...
How to keep data correct and available across nodes. Distributed systems trade off consistency, availability, and partition tolerance (CAP).
