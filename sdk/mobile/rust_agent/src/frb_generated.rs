            ...
            move |context| async move {
                transform_result_sse::<_, String>(
                    (move || async move {
                        ...
                        let output_ok =
                            crate::api::session::AgentSession::abort(&*api_that_guard).await?;
            ...
            move |context| async move {
                transform_result_sse::<_, String>(
                    (move || async move {
                        ...
                        let api_that_guard = api_that_guard.unwrap();
                        let output_ok =
                            crate::api::session::AgentSession::close(&*api_that_guard).await?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
...
fn wire__crate__api__session__AgentSession_park_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, String>((move || {
                ...
                let api_that_guard = api_that_guard.unwrap();
                let output_ok = crate::api::session::AgentSession::park(&*api_that_guard)?;
                std::result::Result::Ok(output_ok)
            })())
        },
    )
            ...
            move |context| async move {
                transform_result_sse::<_, String>(
                    (move || async move {
                        ...
                        let api_that_guard = api_that_guard.unwrap();
                        let output_ok = crate::api::session::AgentSession::reconfigure(
                            &*api_that_guard,
                            api_opts,
                        )
                        .await?;
            ...
            move |context| async move {
                transform_result_sse::<_, String>(
                    (move || async move {
                        ...
                        let api_that_guard = api_that_guard.unwrap();
                        let output_ok =
                            crate::api::session::AgentSession::resume(&*api_that_guard).await?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
            ...
            move |context| async move {
                transform_result_sse::<_, String>(
                    (move || async move {
                        ...
                        let api_that_guard = api_that_guard.unwrap();
                        let output_ok =
                            crate::api::session::AgentSession::snapshot(&*api_that_guard).await?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
...
fn wire__crate__api__session__capability_catalog_json_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "capability_catalog_json",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, String>((move || {
                    let output_ok = crate::api::session::capability_catalog_json()?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, String>(
                    (move || async move {
                        let output_ok =
                            crate::api::session::fetch_supported_models(api_opts).await?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
...
fn wire__crate__api__session__preview_assembled_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, String>((move || {
                    let output_ok =
                        crate::api::session::preview_assembled(api_profile_json, api_project_root)?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__session__skill_app_catalog_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, String>((move || {
                    let output_ok = crate::api::session::skill_app_catalog(api_cache_root)?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__session__skill_portable_list_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, String>((move || {
                    let output_ok =
                        crate::api::session::skill_portable_list(api_user_root, api_project_root)?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        10 => {
            wire__crate__api__session__AgentSession_snapshot_impl(port, ptr, rust_vec_len, data_len)
        }
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        25 => wire__crate__api__session__AgentSession_park_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
